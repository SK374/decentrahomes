const House = ({setShowProperty, propertyId, propertyInfo, setPropertyOwner, setHasPropertyOwner, 
    setPropertyId }) => {
    const clickHandler = () => {
    ...
    return (
        <li onClick={() => clickHandler()}>
            <h3>{propertyInfo.name}, {propertyInfo.streetName}, {propertyInfo.postcode}.</h3>
          </li>
